...
<body id="app-body" class="bg-slate-100 w-screen h-screen m-0 p-0 overflow-hidden">
    ...
    <div id="chat-screen" class="fixed inset-0 w-screen h-screen bg-white flex overflow-hidden hidden">

        <div class="w-[360px] min-w-[360px] bg-white border-r border-slate-200 flex flex-col h-full flex-shrink-0">
        ...
        <div class="flex flex-col flex-1 bg-slate-50 relative h-screen min-w-0 overflow-hidden">
